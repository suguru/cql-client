...
function Frame(values) {
  this.values = values || {};
  this.rawVersion = values.rawVersion;
  this.isRequest = (this.rawVersion & 0x80) === 0;
  this.version = this.rawVersion & 0x7F;
  this.flags = values.flags || 0;
  this.streamId = values.streamId || 0;
  this.opcode = values.opcode;
  this.isTracing = this.flags & 0x02;

  if (this.values.body instanceof Buffer) {
    this.body = this.values.body;
  } else if (typeof this.values.bodyLength === 'number') {
    this.body = new Buffer(this.values.bodyLength);
  }
}
...
Object.defineProperties(Frame.prototype, {
  'isTracing': {
    get: function() { return this._flags & 0x02; },
    enumerable: true
  }
});
...
Object.defineProperties(Message.prototype, {
  ...
  'streamId': {
    ...
    get: function() { return this._streamId; },
    enumerable: true
  }
});
 ...
 */
Message.prototype.enableTracing = function() {
...
function QueryOptions() {
  this.flags = 0;
  this.consistencyLevel = CONSISTENCY_LEVEL.ONE;
  this.values = [];
  this._pageSize = 0;
}
Object.defineProperties(QueryOptions.prototype, {
  'pageSize': {
  ...
  'serialConsistency': {
    set: function(cl) {
      this.flags |= (1 << 0x04);
      this._serialConsistency = cl;
    },
    get: function() { return this._serialConsistency; }
  }
});
 ...
 */
QueryOptions.prototype.setValues = function() {
  var i, args;
  this.flags |= (1 << 0x00);
  ...
  for (i = 0; i < args.length; i++) {
    ...
    this.values.push(args[i] || null);
  }
};

QueryOptions.prototype.skipMetadata = function() {
  this.flags |= (1 << 0x01);
};
...
BatchMessage.prototype.add = function(query, values) {
